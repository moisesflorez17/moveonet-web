export default function Home() {
  return (
    <main className="relative min-h-screen text-white">
      {/* Fondo concierto + textura + overlay */}
      <div
        aria-hidden
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(to bottom, rgba(0,0,0,.85), rgba(10,42,74,.55), rgba(0,0,0,.92))",
        }}
      />

      {/* HEADER (banner superior como en el mock) */}
      ...
      {/* HERO (bloque grande con título y texto a la izquierda) */}
      <section
        id="top"
        className="relative max-w-6xl mx-auto px-4 pt-32 pb-16 md:pt-36 text-left"
      >
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <a
            href="#contacto"
            className="inline-flex items-center px-5 py-2.5 rounded-xl bg-sky-700 hover:bg-sky-800"
          >
      ...
      <section id="contacto" className="max-w-6xl mx-auto px-4 pb-24">
        ...
        <div className="mt-4 grid sm:grid-cols-2 gap-3 text-white/90">
          <a href="mailto:intermoveonet@gmail.com" className="underline">
            intermoveonet@gmail.com
          </a>
          <a href="tel:+573175021246" className="underline">
            +57 317 502 1246
          </a>
        </div>
      </section>
